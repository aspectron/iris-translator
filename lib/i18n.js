...
function i18n(options, callback) {
    ...
    function initMongoStorage(callback) {
        self.mongoStorage = new MongoStorage();
        ...
        function onDataChanged (msg) {
            ...
            self.refreshEntries(function () {
                self.fileStorage.setData(self.entries, function () {});
            });
        };

        self.mongoStorage.init({
    ...
    self.refreshEntries = function (callback) {
        self.fileStorage.getData(function (fileEntries) {
            ...
            if (self.mongoStorage) {
                self.mongoStorage.getData(function (err, mongoEntries) {
                    if (err) {
